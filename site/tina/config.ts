    ...
    collections: [
      ...
      },
      {
        ...
        fields: [
          ...
          {
            type: 'object', name: 'stats', label: 'Key Track Record Stats', list: true,
            ui: { itemProps: (item) => ({ label: `${item?.number || ''} ${item?.label || ''}`.trim() || 'Stat' }) },
            fields: [
              { type: 'string', name: 'number', label: 'Number / Metric', required: true },
              { type: 'string', name: 'label', label: 'Description / Label', required: true },
            ],
          },
          {
            type: 'object', name: 'highlights', label: 'Acceptance Tier Highlights', list: true,
            ui: { itemProps: (item) => ({ label: item?.tier || 'Highlight' }) },
            fields: [
              { type: 'string', name: 'tier', label: 'Tier / Category Name', required: true },
              { type: 'string', name: 'description', label: 'Description & School Highlights', required: true, ui: { component: 'textarea' } },
            ],
          },
          { type: 'string', name: 'methodologyHeading', label: 'Methodology Heading' },
          { type: 'string', name: 'methodologyText', label: 'Methodology Text', ui: { component: 'textarea' } },
          { type: 'string', name: 'disclaimer', label: 'Disclaimer Note', ui: { component: 'textarea' } },
          { type: 'string', name: 'ctaHeading', label: 'CTA Heading' },
          { type: 'string', name: 'ctaLede', label: 'CTA Subtitle', ui: { component: 'textarea' } },
          { type: 'string', name: 'ctaButtonText', label: 'CTA Button Text' },
          { type: 'string', name: 'ctaButtonHref', label: 'CTA Button Link' },
        ],
      },
      {
        name: 'blog',
      ...
      },
      {
        ...
        fields: [
          ...
          { type: 'string', name: 'aboutCtaText', label: 'About CTA Text' },
          { type: 'string', name: 'aboutCtaHref', label: 'About CTA Link' },
