    ...
    collections: [
      ...
      },
      {
        ...
        fields: [
          ...
          { type: 'string', name: 'introHeading', label: 'Intro Heading' },
          { type: 'string', name: 'introParagraphs', label: 'Intro Paragraphs', list: true, ui: { component: 'textarea' } },
          { type: 'string', name: 'crossLinkText', label: 'Cross Link Intro Text' },
          { type: 'string', name: 'crossLinkLabel', label: 'Cross Link Label' },
          { type: 'string', name: 'crossLinkHref', label: 'Cross Link Target URL' },
